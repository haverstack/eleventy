...
- [#4](https://github.com/haverstack/eleventy/pull/4) [`8b9d519`](https://github.com/haverstack/eleventy/commit/8b9d5199f6a163eee2b6fba2ceb9bb00d13378c3) Thanks [@cuibonobo](https://github.com/cuibonobo)! - Bump `@haverstack/core` to `^0.37.0` and `@haverstack/commons` to `^0.31.0`.
